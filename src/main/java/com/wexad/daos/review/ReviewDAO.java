...
public class ReviewDAO extends BaseDAO<Review, UUID> {
    ...
    public UUID save(Review entity) {
        ...
        String id = jdbcTemplate.queryForObject(sql, String.class, entity.getMovieId(), entity.getUserId(), entity.getRating(), entity.getComment());
    ...
    public void update(Review entity) {
        ...
        jdbcTemplate.update(sql, entity.getRating(), entity.getComment(), entity.getId());
    }
